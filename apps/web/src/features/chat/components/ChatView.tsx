...
import { ChatMessage, ChatInput } from '../../../shared/components';
import { EmptyState } from '../../../components/ui';
import { MessageSquare, Sparkles, Paperclip, Mic, Copy, Send } from 'lucide-react';
import { sendMessageToGemini, extractTextFromImage } from '../../../shared/services/geminiService';
import { checkContentSafety, createSupportiveResponse } from '../../../shared/utils/contentSafetyFilter';
...
const ChatView: React.FC<ChatViewProps> = ({
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    try {
      ...
      const apiKeyNotice =
        'Upstream API key expired/invalid. Update the Render GEMINI_API_KEY and redeploy.\n' +
        'API key upstream hết hạn/không hợp lệ. Hãy cập nhật GEMINI_API_KEY trên Render và redeploy.';
