...
import {
  ...
  LiteraryWork
} from "../knowledge/grade10-literature-knowledge";
...
import {
  ...
  quickSearchSgk,
  getAvailableTopics,
} from "../../ai/sgkAiService";
import { isSgkReady, getSgkStatus, getTopicCandidates, findSimilarTopics } from "../../sgk";

// Re-export searchTerms for use in components
export { searchTerms } from "../data/staticDictionary";
// Re-export SGK functions
export { checkSgkAvailability, quickSearchSgk, getAvailableTopics } from "../../ai/sgkAiService";
export { isSgkReady, getSgkStatus, getTopicCandidates, findSimilarTopics } from "../../sgk";
...
const buildGenerateBody = ({ model, contents, config, safetySettings }: GenerateRequest) => {
